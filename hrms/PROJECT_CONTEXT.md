...
- 目前程式通過 ESLint、TypeScript、95 項 Vitest 與 Next.js production build。
...
| Quality | ESLint、TypeScript strict、Vitest（95 tests）、Next production build；Database types drift contract；navigation performance contract；Supabase production rollback-only RLS／Schedule／Punch／Attendance integration tests |
