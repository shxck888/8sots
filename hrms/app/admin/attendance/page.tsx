...
import { AlertTriangle, Calculator, Check, ChevronRight, Clock3, QrCode, RefreshCw, X } from "lucide-react";
...
export default async function AdminAttendancePage({ searchParams }: {
  ...
  return (
    <>
      ...
      <Link className="attendance-qr-entry" href="/admin/attendance/qr-devices"><QrCode size={22} /><span><strong>管理動態 QR 打卡機器</strong><small>新增、配對或停用固定機器</small></span><ChevronRight size={18} /></Link>
