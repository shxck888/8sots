...
export default async function QrDevicesPage() {
  ...
  return <>
    ...
    <section className="admin-panel qr-device-panel">
      <div className="qr-device-intro"><MonitorSmartphone size={26} /><div><strong>配對固定機器</strong><p>先在機器開啟 <a href="/kiosk" rel="noopener noreferrer" target="_blank">打卡機畫面 /kiosk</a> 並安裝成 App，從桌面圖示開啟後，再輸入下方產生的一次性配對碼。配對碼 10 分鐘有效。</p></div></div>
