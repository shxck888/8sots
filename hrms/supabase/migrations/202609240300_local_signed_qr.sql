...
-- A paired kiosk signs each 30-second time slot locally. Validation happens
-- only when an employee submits a scan. Version 1 remains valid during rollout.
create function public.validate_punch_qr_token(
...
revoke all on function public.validate_punch_qr_token(
